    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          <?php $pathprofile = !empty($row['inter_profile']) ? $row['inter_profile'] :'../upload/applicant/profile/profile.png'; ?>
          <img src="<?= $pathprofile ?>" alt="Profile" class="profile1 rounded-circle">
          <h2><?= $row['inter_no_pekerja'] ?></h2>
          <h3 class="text-center"><?= empty($row['fac_name']) ? 'Kemaskini Profile anda Sekarang' : $row['fac_name'] ; ?></h3>
        </div>
      </div>
        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              <h5 class="c-title">Maklumat Penemuduga</h5>

              <div class="row">
                <div class="col-lg-3 col-md-4 label ">Nama</div>
                <div class="col-lg-9 col-md-8"><?= ucwords(strtolower($row['inter_name'])) ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">No Pekerja</div>
                <div class="col-lg-9 col-md-8"><?= $row['inter_no_pekerja'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">No Kad Pengenalan</div>
                <div class="col-lg-9 col-md-8"><?= $row['inter_ic'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">No Telefon</div>
                <div class="col-lg-9 col-md-8"><?= $row['inter_tel'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Emel</div>
                <div class="col-lg-9 col-md-8"><?= $row['inter_email'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Fakulti</div>
                <div class="col-lg-9 col-md-8"><?= $row['fac_name'] ?></div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Tarikh daftar</div>
                <div class="col-lg-9 col-md-8"><?= date('d/m/Y', strtotime($row['inter_created_at'])); ?></div>
              </div>
            </div>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="name" type="text" class="form-control" id="fullName" value="<?= $row['inter_name'] ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="tel" type="text" class="form-control" value="<?= $row['inter_tel'] ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="email" type="email" class="form-control" value="<?= $row['inter_email'] ?>">
                  </div>
                </div>

                <div class="row mb-3">
                  <label for="company" class="col-md-4 col-lg-3 col-form-label">Fakulti</label>
                  <div class="col-md-8 col-lg-9">
                  <select class="form-select mt-auto" name="fac">
                    <option disabled selected value>---</option>
                    <?php
                    $fac = $conn->query("SELECT * FROM faculty");
                    while ($row_fac = mysqli_fetch_assoc($fac)){
                      if($row_fac['fac_id'] == $row['inter_faculty']){
                        echo "<option value='{$row_fac['fac_id']}' selected>{$row_fac['fac_name']}</option>";
                      }else{
                        echo "<option value='{$row_fac['fac_id']}' >{$row_fac['fac_name']}</option>";
                      }
                    }
                    ?>
                  </select>
