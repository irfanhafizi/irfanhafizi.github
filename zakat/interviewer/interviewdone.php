            ...
            <table class="table datatable1" id="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>RM <?= $row['interview_amt'] ?></td>
                  <td>RM <?= $row['interview_amt_final'] ?></td>
                  <td><?= empty($row['interview_nota']) ? '---': $row['interview_nota']; ?></td>
                  <td><strong class="<?= $row['status_id'] == 8 ? 'text-success': ($row['status_id'] == 9 ? 'text-danger':'text-primary'); ?>"><?= $row['status_name'] ?></strong></td>
                </tr>
