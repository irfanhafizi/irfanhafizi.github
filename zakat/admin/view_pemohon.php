      ...
      <div class="col-12">
        <div class="card overflow-auto">
          ...
          <div class="card-body">
            ...
            <div class="row mb-3">
              <?php $pathprofile = !empty($row_pemohon['app_profile']) ? $row_pemohon['app_profile'] :'../upload/applicant/profile/profile.png'; ?>
              <img src="<?= $pathprofile ?>" alt="Profile" style="width:200px">
            </div>
            <div class="row mb-3">
