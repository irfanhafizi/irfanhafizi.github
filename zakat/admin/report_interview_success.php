...
if(isset($_GET['filter1'])){
  ...
  WHERE apply_status = 8 AND interview_interviewer = '$filter' ");
  ...
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 8 AND app_faculty = '$filter' ");
  ...
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 8 AND apply_sesi = '$filter' ");
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI KEPUTUSAN BERJAYA</h5>
            ...
            <table class="table table-borderless datatable1" id="table">
              <thead>
                <tr>
                  ...
                  <th class="bg-danger">Jumlah Dinilai</th>
                  <th class="bg-danger">Jumlah Disahkan</th>
                </tr>
              </thead>
              <tbody>
                <form>
