...
if(isset($_GET['filter1'])){
  ...
  WHERE apply_status = 4 AND interview_interviewer = '$filter' ");
  ...
  LEFT JOIN faculty ON fac_id = app_faculty
  LEFT JOIN status ON status_id = apply_status
  WHERE apply_status = 4 AND app_faculty = '$filter' ");
  ...
  LEFT JOIN faculty ON fac_id = app_faculty
  LEFT JOIN status ON status_id = apply_status
  WHERE apply_status = 4 AND apply_sesi = '$filter' ");
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI SEMAKAN PERLU PEMBETULAN</h5>
