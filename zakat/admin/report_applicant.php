    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI PEMOHON</h5>
            ...
            <table class="table table-borderless datatable1" id="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $row['fac_name'] ?></td>
                  <td><?= $row['kod_name'] ?></td>
                  <td><?= date('d F Y', strtotime($row['app_created_at'])) ?></td>
                </tr>
