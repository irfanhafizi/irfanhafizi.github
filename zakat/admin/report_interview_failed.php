...
if(isset($_GET['filter1'])){
  ...
  JOIN interview ON interview_apply = apply_id
  JOIN interviewer ON inter_no_pekerja = interview_interviewer
  LEFT JOIN sesi ON sesi_id = apply_sesi
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 9 AND apply_status = 9 AND interview_interviewer = '$filter' ");
  ...
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 9 AND apply_status = 9 AND app_faculty = '$filter' ");
  ...
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 9 AND apply_status = 9 AND apply_sesi = '$filter' ");
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI KEPUTUSAN GAGAL</h5>
