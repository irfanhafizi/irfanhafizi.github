...
$apply = $conn->query("SELECT * FROM interview
...
LEFT JOIN status ON status_id = interview_status
WHERE apply_sesi = '$latest_sesi' AND interview_status = 7 ");
?>
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">PENGESAHAN KEPUTUSAN BAGI <?= $row_sesi['sesi_name'] ?></h5>
            ...
            <table id="table" class="table table-borderless datatable1">
              <thead>
                <tr>
                  ...
                  <th>Semester</th>
                  <th>Nama Penemuduga</th>
                  <th>No. Pekerja Penemuduga</th>
                </tr>
              </thead>
              <tbody>
                <form>
                ...
                <tr>
                  ...
                  <td><?= $row['interview_interviewer'] ?></td>
                    <td class="text-end"><a class="btn btn-primary btn-sm rounded-pill w-100" href="interview_final.php?id=<?= $row['apply_id'] ?>">Kemaskini Permohonan</a></td>
                </tr>
