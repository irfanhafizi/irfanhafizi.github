...
$query_get = "SELECT * FROM interview
  LEFT JOIN apply ON interview_apply = apply_id
  ...
  LEFT JOIN sesi ON interview_sesi = sesi_id
      ...
      <div class="row">
        ...
        <div class="card overflow-auto">
          ...
          <div class="card-body">
            ...
            <h4 class="c-title2">PENGESAHAN KEPUTUSAN</h4>
            ...
            <div class="row mb-3">
              ...
              <strong class="col-sm-9 col-7">: <?php echo 'RM '.$row_pemohon['apply_pendapatan_bapa_sebulan'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">JUMLAH PENDAPATAN IBU SEBULAN</label>
              <strong class="col-sm-9 col-7">: <?php echo 'RM '.$row_pemohon['apply_pendapatan_ibu_sebulan'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">LAIN-LAIN PENDAPATAN SEBULAN</label>
              <strong class="col-sm-9 col-7">: <?php echo 'RM '.$row_pemohon['apply_pendapatan_lain_sebulan'] ?></strong>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <strong class="col-sm-9 col-7">: <?php echo 'RM '.$row_pemohon['apply_jumlah_tajaan'] ?></strong>
            </div>
            <div class="row mb-3">
            ...
            <h5 class="c-title">MAKLUMAT PENILAIAN SELEPAS TEMUDUGA</h5>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">KATEGORI ASNAF PEMOHON</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['interview_asnaf'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">TAHAP PENGAJIAN PEMOHON</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['interview_pengajian'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">ADAKAH PEMOHON DITAJA?</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['interview_pinjaman'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">ADAKAH PEMOHON ANAK YATIM ATAU OKU?</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['interview_yatim'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">PENILAIAN TEMUDUGA</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['interview_nota'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">KEPUTUSAN JUMLAH ZAKAT YANG DICADANGKAN</label>
              <strong class="col-sm-9 col-7">: RM <?php echo $row_pemohon['interview_amt'] ?></strong>
            </div>
            ...
            <div class="my-3 justify-center">
              ...
              <div class="row my-3">
                  ...
                  <label class="form-label">JUMLAH ZAKAT YANG DILULUSKAN OLEH KOORDINATOR ZAKAT (RM)</label>
                  </div>
                  <div class="col-sm-4 col-7">
                    <div class="d-flex">
                    <strong>:</strong><input type="number" min="0" step="0.01" name="amt" value="<?= $row_pemohon['interview_amt'] ?>" class="form-control mx-2 w-90"></input>
                    </div>
                  </div>
                </div>
                <div class="d-flex my-3 justify-center">
              <button class="btn btn-success mx-1 my-1" name="sah" type="submit">Permohonan Diterima</button>
              <button class="btn btn-danger mx-1 my-1 " name="gagal" type="submit">Permohonan  Ditolak</button>
                </div>
            </div>
          </form>
          </div>
