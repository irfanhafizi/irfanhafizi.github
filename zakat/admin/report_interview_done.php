...
if(isset($_GET['filter1'])){
  ...
  WHERE apply_status = 7 AND interview_interviewer = '$filter' ");
  ...
  LEFT JOIN status ON status_id = apply_status
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 7 AND app_faculty = '$filter' ");
  ...
  LEFT JOIN status ON status_id = apply_status
  LEFT JOIN semester ON sem_id = apply_sem
  WHERE apply_status = 7 AND apply_sesi = '$filter' ");
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI TEMUDUGA TELAH SELESAI</h5>
            ...
            <table id="table" class="table table-borderless datatable1" >
              <thead>
                <tr>
                  ...
                  <th class="bg-info">Jumlah Dinilai</th>
                </tr>
              </thead>
              <tbody>
                <?php
