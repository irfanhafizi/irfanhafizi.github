...
if(isset($_GET['filter1'])){
  ...
  WHERE apply_status = 5 AND apply_sem = '$filter' ");
  ...
  LEFT JOIN faculty ON fac_id = app_faculty
  LEFT JOIN status ON status_id = apply_status
  WHERE apply_status = 5 AND app_faculty = '$filter' ");
  ...
  LEFT JOIN faculty ON fac_id = app_faculty
  LEFT JOIN status ON status_id = apply_status
  WHERE apply_status = 5 AND interview_sesi = '$filter' ");
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">SENARAI SEMAKAN DITOLAK</h5>
