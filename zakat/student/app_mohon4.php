...
if(isset($_POST['next'])){
  ...
  $tajaan = $_POST['tajaan'];
  $jumlah = $_POST['jumlah'];
  $terima = strtoupper($_POST['terima']);
  $sebab = $_POST['sebab'];
  ...
  try{
    ...
    $pendapatan = $row1['apply_pendapatan_bapa_sebulan']+$row1['apply_pendapatan_ibu_sebulan']+$row1['apply_pendapatan_lain_sebulan']+$jumlah;
    ...
    if ($pendapatan > $keperluan) {
      ...
      apply_tajaan='$tajaan',
      apply_jumlah_tajaan='$jumlah',
      apply_terima_zakat='$terima',
...
if(isset($_POST['back'])){
  ...
  $jumlah = $_POST['jumlah'];
  $terima = strtoupper($_POST['terima']);
  $kifayah = strtoupper($_POST['kifayah']);
  $sebab = $_POST['sebab'];
