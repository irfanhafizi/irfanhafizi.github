...
$query_get = "SELECT * FROM apply
  ...
  LEFT JOIN bank ON bank_id = apply_nama_bank
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="card overflow-auto">
          ...
          <div class="card-body">
            <h4 class="c-title2">PERMOHONAN ZAKAT SARA DIRI</h4>
            <h5 class="c-title1">SILA SEMAK SEBELUM HANTAR</h5>
            ...
            <div class="row mb-3">
              ...
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['apply_matric'] ?></strong>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-5">NO KAD PENGENALAN</label>
              <strong class="col-sm-9 col-7">: <?php echo $row_pemohon['app_ic'] ?></strong>
            </div>
            <div class="row mb-3">
            ...
            <div class="d-flex mb-3 justify-center">
              <div class="col-sm-3 d-flex justify-center">
                <button class="btn btn-success mx-1" name="apply_submit" type="submit">HANTAR</button>
              <a class="btn btn-dark mx-1" href="mohon_bahagian1.php?id=<?= $encoded_id ?>">Edit Semula</a>
              </div>
            </div>
              </form>
          </div>
