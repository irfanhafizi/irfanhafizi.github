...
if(isset($_GET['filter3'])){
  ...
  WHERE apply_matric = '$app_id' AND apply_status != 5 AND apply_status != 8 
  AND apply_status != 9 AND apply_sesi = '$filter'");
}else{
  $apply = $conn->query("SELECT * FROM apply
  LEFT JOIN applicant ON app_matric = apply_matric
  LEFT JOIN sesi ON sesi_id = apply_sesi
    ...
    <section class="section dashboard">
      <div class="col-12">
        <div class="card overflow-auto">
          <div class="card-body">
            <h5 class="c-title">Senarai Permohonan Belum Selesai</h5>
