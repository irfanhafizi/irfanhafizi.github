...
<div class="content">
    ...
    <form name="search" method="post" action="searchsales_staff.php" role="search" class="form-horizontal" style=""> 
 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="searchsales_staff.php"</script>';  
           }  
      }  
      else  
      {  
...
{ 
    ...
    if($row['purity'] == 22){
        ...
        $update = mysqli_query($connection, "UPDATE inventory SET price='$price' WHERE stock_id='$stock_id' AND status='Available'");
                ...
                ?>
    <form method="post" action="searchsales_staff.php?action=add&id=<?php echo $row["stock_id"]; ?>">
    <tr>
        <td><?php echo $no ?></td>
...
<table class="table  table-striped table-hover table-responsive">
    ...
    <tr>  
        ...
        <td><a class="btn btn-danger btn-md" href="searchsales_staff.php?action=delete&id=<?php echo $values["stock_id"]; ?>"><span >Remove from List</span></a></td>  
    </tr>
    <?php  
    ...
    <tr class="info">  
        ...
        <td><a class="btn btn-primary btn-md" href="order_staff.php">Make a Receipt</a></td>  
    </tr>  
    <?php  
    }else{
        echo '<tr><td colspan="14">No data retrieved..</td></tr>';
