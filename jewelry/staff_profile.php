...
<div class="content">
<h2>Staff Profile &raquo; <?php echo $row['username'] ?></h2>
<hr/>
<?php
        ...
        if(isset($_GET['action']) == 'delete')
            ...
            $shop = $row['shop'];
                        ...
                        <a href="index_staff.php" class="btn btn-default">
                            <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Back
                        </a>
                        <a href="update_staff.php?icno=<?php echo $row['icno']; ?>" class="btn btn-primary">
                        ...
                        <a href="password_staff.php" class="btn btn-warning">
